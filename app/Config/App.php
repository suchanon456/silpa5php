...
use Silpa5PHP\Session\Handlers\FileHandler;
...
class App extends BaseConfig
{
     ...
     *    http://example.com/
     */
    //public string $baseURL = 'http://localhost:8080/action_plan/public/';
    ...
    public $logDirectory = WRITEPATH . 'logs/';
    
    public $logLevel = 2; // ระดับการบันทึกข้อผิดพลาด: 0 = ไม่บันทึก, 1 = บันทึกแบบแสดงผลเฉพาะ, 2 = บันทึกทั้งหมด
}
